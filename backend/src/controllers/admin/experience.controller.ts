...
export async function list(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json(await experienceService.adminList(parseListOpts(req.query as Record<string, unknown>)));
  } catch (err) {
    next(err);
  }
}
...
export async function getOne(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await experienceService.getById(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.status(201).json({ data: await experienceService.create(req.body) });
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await experienceService.update(Number(req.params.id), req.body) });
  } catch (err) {
    next(err);
  }
}
...
export async function softDelete(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    await experienceService.softDelete(Number(req.params.id));
    res.status(204).send();
  } catch (err) {
    next(err);
  }
...
export async function archive(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await experienceService.archive(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
...
export async function restore(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await experienceService.restore(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
