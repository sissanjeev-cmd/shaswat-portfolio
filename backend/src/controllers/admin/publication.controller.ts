...
export async function list(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json(await publicationService.adminList(parseListOpts(req.query as Record<string, unknown>)));
  } catch (err) {
    next(err);
  }
}
...
export async function getOne(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await publicationService.getById(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.status(201).json({ data: await publicationService.create(req.body) });
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await publicationService.update(Number(req.params.id), req.body) });
  } catch (err) {
    next(err);
  }
}
...
export async function softDelete(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    await publicationService.softDelete(Number(req.params.id));
    res.status(204).send();
  } catch (err) {
    next(err);
  }
...
export async function archive(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await publicationService.archive(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
...
export async function restore(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    res.json({ data: await publicationService.restore(Number(req.params.id)) });
  } catch (err) {
    next(err);
  }
}
